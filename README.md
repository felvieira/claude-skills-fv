...
# Dev Team Kit — 71 Specialist Skills for Coding Agents
...
In the table below, treat `dev-team-kit` as 38 tools backed by the 71 skills (71 installed skill directories; ID 16 is reserved).
