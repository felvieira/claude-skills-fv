...
# Dev Team Kit — 64 Specialist Skills for Coding Agents

![Version](https://img.shields.io/badge/version-2.65.0-0f766e)
![Skills](https://img.shields.io/badge/skills-64-1d4ed8)
...
Installs the 64 skills and hooks globally. Works in any project with no extra configuration.
...
In the table below, treat `dev-team-kit` as 38 tools backed by the 64 skills (64 installed skill directories; ID 16 is reserved).
