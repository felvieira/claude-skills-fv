...
# Dev Team Kit — 74 Specialist Skills for Coding Agents
...
Backend, frontend, mobile (Tauri), observability, analytics, accessibility (WCAG), refactoring, release, **canary deployments** (v2.12+), documentation — **74 specialists in total** (74 installed skill directories; ID 16 is reserved). Each task goes to the right professional, on the right AI model (Haiku for simple, Sonnet for medium, Opus for architecture) — you don't pay Opus to generate boilerplate.
...
Installs the 74 skills and hooks globally. Works in any project with no extra configuration.
...
In the table below, treat `dev-team-kit` as 38 tools backed by the 74 skills (74 installed skill directories; ID 16 is reserved).
...
| 35 | **Skill Author** | meta-skill to create, edit, eval and optimize the kit's own skills — sustains the kit as it grows past 74 specialists |
