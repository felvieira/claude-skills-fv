...
> **Procurando a wiki completa?** → [`docs/WIKI.md`](./WIKI.md). Tem **todos os 73 skills + 16 subagents + 45 commands + 62 policies + 29 hooks + 22 rules path-scoped + plugin + MCP**, formato aihero, com exemplos.
>
