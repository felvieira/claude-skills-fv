...
> **Procurando a wiki completa?** → [`docs/WIKI.md`](./WIKI.md). Tem **todos os 62 skills + 16 subagents + 45 commands + 61 policies + 29 hooks + 22 rules path-scoped + plugin + MCP**, formato aihero, com exemplos.
>
...
> **Versão:** 62 skills, 16 subagents, 45 slash commands, 61 policies, 29 hooks, 22 rules path-scoped (TS/Python/React/backend/database/frontend + common)
