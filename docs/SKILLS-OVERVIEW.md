...
> **Procurando a wiki completa?** → [`docs/WIKI.md`](./WIKI.md). Tem **todos os 49 skills + 16 subagents + 39 commands + 50 policies + rules path-scoped + plugin + MCP**, formato aihero, com exemplos.
>
...
> **Versão:** 49 skills, 16 subagents, 39 slash commands, 50 policies, rules path-scoped (TS/Python/React + common)
...
50 policies compartilhadas em `policies/`. Não precisa ler todas — as 5 mais importantes:
