...
> **Procurando a wiki completa?** → [`docs/WIKI.md`](./WIKI.md). Tem **todos os 42 skills + 15 subagents + 31 commands + 45 policies + plugin + MCP**, formato aihero, com exemplos.
>
...
> **Versão:** 42 skills, 15 subagents, 31 slash commands, 45 policies
> **Última atualização:** 2026-05-23 (v2.12.1)
