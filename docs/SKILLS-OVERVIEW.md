...
> **Procurando a wiki completa?** → [`docs/WIKI.md`](./WIKI.md). Tem **todos os 71 skills + 16 subagents + 45 commands + 62 policies + 29 hooks + 22 rules path-scoped + plugin + MCP**, formato aihero, com exemplos.
>
...
> **Versão:** 71 skills, 16 subagents, 45 slash commands, 62 policies, 29 hooks, 22 rules path-scoped (TS/Python/React/backend/database/frontend + common)
...
62 policies compartilhadas em `policies/`. Não precisa ler todas — as 5 mais importantes:
