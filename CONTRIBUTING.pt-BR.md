> 🌎 [English version](CONTRIBUTING.md) · 🇧🇷 Versão em Português
...
- [Adicionando uma nova policy](#adicionando-uma-nova-policy)
- [Adicionando um program](#adicionando-um-program-pipeline-declarativo-yaml)
- [Adicionando um subagent](#adicionando-um-subagent)
...
├── mcp-server/       ← servidor MCP TypeScript (expõe 38 tools)
